var vidaAtual = 11
var vidaMax = 11
var sanidadeatual = 14
var sanidadetotal= 40
var banco = 18000
...
html9 += "<tr><td>Nome</td><td>Clara Leger Rodrigues</td></tr>"

html9 += "<tr><td>Jogador</td><td>Gabriela</td></tr>"

html9 += "<tr><td>Ocupação</td><td>Arqueóloga</td></tr>"

html9 += "<tr><td>Idade</td><td>22</td></tr>"

html9 += "<tr><td>Gênero</td><td>Feminino</td></tr>"

html9 += "<tr><td>Local De Nascimento</td><td>São Paulo</td></tr>"

html9 += "<tr><td>Local De Residência</td><td>Caracas, Venezuela</td></tr>"

html9 += "<tr><td colspan='3'>Dano Extra:1d4      Corpo:1     Exposição Paranormal: "+ localStorage.getItem('expparanormal') +"%  <input type='number1' id='number' size='2.5'><input name='submit' type='submit' onclick='assignVar()'></td></tr>"
...
function pericias(vida){
	...
	html3 +="<td>7</td>"
	html3 +="<td><button onClick='roll7()'>ROLL</button></td></tr>"
